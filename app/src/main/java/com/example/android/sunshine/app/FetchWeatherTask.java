...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
         ...
         mContext.getString(R.string.pref_temp_metric_key));

        if (unitType.equals(mContext.getString(R.string.pref_temp_imperial_key))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.pref_temp_metric_key))) {
     ...
     throws JSONException {
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                int rowsCreated  = mContext.getContentResolver().bulkInsert(
