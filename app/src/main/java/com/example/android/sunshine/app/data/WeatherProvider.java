...
public class WeatherProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        if (getContext() != null) {
            ...
            throw new UnknownError("The Context is null");
        }
        return retCursor;
    }
    ...
    public int update(@NonNull Uri uri, ContentValues values, String selection,
        ...
        switch (match) {
        case WEATHER: {
            rowsAffected = db.update(WeatherContract.WeatherEntry.TABLE_NAME, values, selection,
                                     selectionArgs);
            break;
        }
        case LOCATION : {
            rowsAffected = db.update(WeatherContract.LocationEntry.TABLE_NAME, values, selection,
                                     selectionArgs);
            break;
        }
        default:
